...
<head>
    ...
    <title>Museum Landing Page</title>
...
<body>
    ...
    <div class="relative w-full h-[320px]" id="home">
        ...
        <div class="absolute inset-9 flex flex-col md:flex-row items-center justify-between">
            <div class="md:w-1/2 mb-4 md:mb-0">
                <h1 class="text-grey-700 font-medium text-4xl md:text-5xl leading-tight mb-2">Museum Negara</h1>
                <p class="font-regular text-xl mb-8 mt-4">jalan Merdeka Raya Jakarta Selatan</p>
    ...
    <!-- Modal -->
    <div id="guestbookModal" class="fixed inset-0 hidden bg-black bg-opacity-50 flex justify-center items-center">
        <div class="bg-white p-6 rounded-lg shadow-lg w-96">
            <h2 class="text-xl font-bold mb-4">Buku Tamu</h2>
            <form id="guestbookForm" action="proses_tamu.php" method="POST">
                <label class="block mb-2">Nama Pengunjung:</label>
                <input type="text" name="nama" class="w-full border p-2 rounded mb-3" placeholder="Masukkan nama"
                    required>

                <label class="block mb-2">Alamat:</label>
                <input type="text" name="alamat" class="w-full border p-2 rounded mb-3" placeholder="Masukkan alamat"
                    required>

                <label class="block mb-2">Tanggal Kunjungan:</label>
                <input type="date" name="tanggal_kunjungan" class="w-full border p-2 rounded mb-3" required>

                <label class="block mb-2">Instansi:</label>
                <input type="text" name="instansi" class="w-full border p-2 rounded mb-3"
                    placeholder="Masukkan instansi" required>

                <div class="flex justify-end mt-4">
                    <button type="button" onclick="closeModal()"
                        class="px-4 py-2 bg-gray-400 text-white rounded mr-2">Batal</button>
                    <button type="submit" class="px-4 py-2 bg-[#c8a876] text-white rounded">Simpan</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="container mx-auto flex flex-wrap items-center justify-between">
                ...
                <div class="w-full md:w-1/2 md:text-center md:mb-0 mb-8">
                    <ul class="list-reset flex justify-center flex-wrap text-xs md:text-sm gap-3">
                        ...
                        <li class="mx-4"><a href="/privacy" class="text-gray-400 hover:text-white">Privacy Policy</a>
                        </li>
                    </ul>
                </div>
            </div>
